...
import os
# Workaround: allow duplicate libomp on macOS when multiple runtimes load.
# Set before importing libraries that may initialize OpenMP (faiss, numpy, etc.).
...
os.environ['LANGCHAIN_PROJECT']= '  rag v4  LLM app'
