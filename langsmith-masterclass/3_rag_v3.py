...
os.environ['LANGCHAIN_PROJECT']= '  rag 3  LLM app'
PDF_PATH = "islr.pdf"  # <- change to your file

# ----------------- helpers (not traced individually) -----------------
@traceable(name="load_pdf"  ,tag = ['pdf' , 'loader'] , metadata= {'loader' : 'pdfloader'})
...
@traceable(name="build_vectorstore" ,tag = ['embedding ' , 'vectorstore'] , metadata= {'embedding-model' : 'text-embedding-3-small'})
